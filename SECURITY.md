...
Replace this section with the supported versions for `homebrew-tap`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `homebrew-tap` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in /tmp/homebrew-tap-stackforge.
